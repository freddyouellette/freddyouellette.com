				...
				<div className="container">
					<div className="row py-3 mt-5" style={{"fontFamily":"Times"}}>
						<div className="col-12 col-md-6 degree-well">
							<div className="row">
								<div className="col-8 col-sm-6 col-lg-5 m-auto">
									<a href="https://www.ram.ac.uk/" target="_blank" rel="noopener noreferrer">
						...
						<div className="col-12 col-md-6 degree-well">
							<div className="row">
								<div className="col-8 col-sm-6 col-lg-5 m-auto">
									<a href="https://www.unt.edu/" target="_blank" rel="noopener noreferrer">
					...
					<div className="row music-feature">
						...
						<div className="col-12 col-md-8 px-5">
							<AudioPlayer audioName='audPortalsAuguries'/>
							<AudioPlayer audioName='audPortalsBellsAcross'/>
							<AudioPlayer audioName='audPortalsJungla'/>
							<div>
								<br/>
								<p className="text-sm">
					...
					<div className="row music-feature">
						...
						<div className="col-12 col-md-8 px-5">
							<AudioPlayer audioName="audTwoNardis"/>
							<AudioPlayer audioName="audTwoVaguelyReminiscient"/>
							<AudioPlayer audioName="audTwoETicket"/>
							<p className="text-sm">
								UNT is known around the world for their jazz lab bands. They have over a dozen, ranging from the cutting-edge jazz of the <a href="https://en.wikipedia.org/wiki/One_O%27Clock_Lab_Band" target="_blank" rel="noopener noreferrer">One O'Clock Lab Band</a>, to the specialized music of the Latin Jazz Ensemble. The Two O'Clock was usually known for playing more of the classNameics. It was directed by <a href="https://en.wikipedia.org/wiki/Jay_Saunders" target="_blank" rel="noopener noreferrer">Jay Saunders</a>, who has a history of playing lead trumpet for the greats, including the Stan Kenton Orchestra. There actually was an enormous collection of music donated to UNT by Stan Kenton himself, leading to the reason why they organize their jazz bands in the unusually heavy orchestration of 5 trumpets, 5 trombones, and 5 saxes. I played 4th trombone on this album.
							</p>
						</div>
					</div>
					<hr/>
					<div className="row music-feature">
						<div className="col-12 col-md-6 text-center mb-5">
							<a href="https://www.youtube.com/watch?v=h5Zi9zZr-rM?start=567" target="_blank" rel="noopener noreferrer">
						...
						<div className="col-12 col-md-6 text-center mb-5">
							<a href="https://www.youtube.com/watch?v=9sj7_L8g0eY" target="_blank" rel="noopener noreferrer">
								<i className="fa fa-play-circle fa-3x position-absolute ml-3 mt-3"></i>
						...
						<div className="col-12 col-md-6 text-center">
							<a href="https://www.youtube.com/watch?v=PMvks7HpBeo" target="_blank" rel="noopener noreferrer">
								<i className="fa fa-play-circle fa-3x position-absolute ml-3 mt-3"></i>
						...
						<div className="col-12 col-md-6 text-center">
							<a href="https://www.youtube.com/watch?v=FmKymqHg4ak" target="_blank" rel="noopener noreferrer">
								<i className="fa fa-play-circle fa-3x position-absolute ml-3 mt-3"></i>
					...
					<div className="row music-feature">
						...
						<div className="col-12 col-md-8 px-5">
							<AudioPlayer audioName="audBrooklynBridge1"/>
							<AudioPlayer audioName="audBrooklynBridge2"/>
							<AudioPlayer audioName="audBrooklynBridge3"/>
							<AudioPlayer audioName="audBrooklynBridge4"/>
							<p className="text-sm">
